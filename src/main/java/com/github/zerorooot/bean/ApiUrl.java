...
public class ApiUrl {
    ...
    public static final String DOWNLOAD = "https://api.6pan.cn/v3/newfile/download";
    ...
    public static final String ADDOFFLINE = "https://api.6pan.cn/v3/offline/add";
    public static final String OFFLINELIST = "https://api.6pan.cn/v3/offline/list";
    public static final String DELETECOMPLETE = "https://api.6pan.cn/v3/offline/clear";
    public static final String OFFLINEDELETE = "https://api.6pan.cn/v3/offline/delete";
}
